...
namespace PrositCore {
    class QBDResourceReservationProbabilitySolver: public ResourceReservationProbabilitySolver {
        ...
        private:    
            ...
            void extract_sub_matrices(const MatrixXd & mat, 
                                      int dim, 
                                      MatrixXd & B, 
                                      MatrixXd & A0, 
                                      MatrixXd & A1, 
            ...
            double matrix_prob_ts_compressed(int i, int j, int q, 
            ...
            ///@param p cdf of the computation time
            ///@param u pmf of the interarrival time
            double matrix_prob_ts(int i, int j, int q, 
                                  const PrositAux::cdf &p, 
                                  const PrositAux::pmf &u);
    };
    ...
    class LatoucheResourceReservationProbabilitySolver : public QBDResourceReservationProbabilitySolver {
        public:
            ...
            LatoucheResourceReservationProbabilitySolver(unsigned int grand, double epsilon_d, 
                                                         unsigned int max_iter_d):  
                                                            QBDResourceReservationProbabilitySolver(grand), 
                                                            epsilon(epsilon_d), 
                                                            max_iter(max_iter_d) {
                if(epsilon < 0)
